...
TO_JB_MAIN_BRANCH=integration-snap/$FIRST_FOLDER/$CURRENT_COMMIT/to-jb-main
...
TO_INTEGRATION_BRANCH=integration-snap/$FIRST_FOLDER/$CURRENT_COMMIT/to-integration
